...
class GameDetailView {
  ...
  renderTeamLeaders() {
    ...
    const leaderCategories = {
      passing: leaders.find(
        l => l.name === 'passingLeader' || l.name === 'passingYards'
      ),
      rushing: leaders.find(
        l => l.name === 'rushingLeader' || l.name === 'rushingYards'
      ),
      receiving: leaders.find(
        l => l.name === 'receivingLeader' || l.name === 'receivingYards'
      ),
    };
